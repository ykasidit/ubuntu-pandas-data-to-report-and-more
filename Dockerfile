...
USER report_worker
RUN mkdir -p ~/azenqos_qgis_plugin
RUN mkdir -p ~/.local/share/QGIS/QGIS3/profiles
ADD --chown=report_worker azenqos_qgis_plugin /home/report_worker/azenqos_qgis_plugin
ADD --chown=report_worker profiles /home/report_worker/.local/share/QGIS/QGIS3/profiles
WORKDIR /home/report_worker/azenqos_qgis_plugin
